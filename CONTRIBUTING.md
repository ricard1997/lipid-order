...
We welcome all contributions to lipid-order!

Contributions can take many forms, such as:

* sharing bug reports or feature requests through the [Issue Tracker](https://github.com/ricard1997/lipid_order/issues)
...
The second two options both involve making a [pull request](https://github.com/ricard1997/lipid_order/pulls) .
